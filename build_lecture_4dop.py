...
SCRIPT = [
    ...
    ("5. НЕЛИНЕЙНАЯ ОПТИКА: ГЕНЕРАЦИЯ ВТОРОЙ ГАРМОНИКИ", "12:08 – 19:22 (стенка 7,2 мин = чтение 3,5 мин + доска/паузы 3,7 мин)", [
        ...
        "Расшифровка каждого символа — в таблице на слайде.",
    ...
    ("6. МОЁ ПРЕДЛОЖЕНИЕ: ДВУХПРОХОДНАЯ СХЕМА С ТЕРМОКОМПЕНСАЦИЕЙ", "19:22 – 25:14 (стенка 5,9 мин = чтение 2,8 мин + доска/паузы 3,1 мин)", [
    ...
    ("7. ИТОГОВЫЕ ТЕЗИСЫ", "25:14 – 27:00 (стенка 1,8 мин = чтение 1,8 мин)", [
    ...
    ("8. ЗАКЛЮЧЕНИЕ", "27:00 – 28:00 (стенка 1,0 мин = чтение 1,0 мин)", [
...
CHI_TABLE = {
    ...
    "rows": [
        ...
        ["ε_{0}", "Электрическая постоянная", "Ф/м", "8,85·10^{-12} Ф/м"],
...
def build_pdf():
    ...
    elements.append(Paragraph(
        ...
        "Строки «Доска / пауза:» — ремарки лектору, не читаются вслух. Целевой хронометраж лекции: 28 минут.",
        hint,
    ))
