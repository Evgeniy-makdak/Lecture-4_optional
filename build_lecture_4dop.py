...
SCRIPT = [
    ...
    ("6. МОЁ ПРЕДЛОЖЕНИЕ: ДВУХПРОХОДНАЯ СХЕМА С ТЕРМОКОМПЕНСАЦИЕЙ", "19:50 – 28:14 (стенка 8,4 мин = чтение 5,3 мин + доска/паузы 3,1 мин)", [
    ...
    ("7. ИТОГОВЫЕ ТЕЗИСЫ", "28:14 – 30:00 (стенка 1,8 мин = чтение 1,8 мин)", [
    ...
    ("8. ЗАКЛЮЧЕНИЕ", "30:00 – 31:00 (стенка 1,0 мин = чтение 1,0 мин)", [
